...
$bal = $row['balance'] + $pay;
    ...
    $sql1 = "INSERT INTO tbl_transaction (tx_no, tx_type, amount, date, description, to_accno, account, status,comments,charges)
    
    VALUES ('$token', '$type', '$amount', '$txndate', '$description', '$to', '$account','$status','$description','$charges')";
...
has been credited with the sum of '.  $currency.''.$amount.' at the charges of '.  $currency.''.$charges.' Available balance  '.  $currency.''.$bal.'</p> <div style="margin-top: 25px;">
...
if($mail->send()) {
     ...
     $sql = "UPDATE tbl_users SET balance= balance + $pay  WHERE email='$email'";
...
has been debited with the sum of '.  $currency.''.$amount.' at the charges of '.  $currency.''.$charges.' Available balance  '.  $currency.''.$bal.'</p> <div style="margin-top: 25px;">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <?php if($msg != "") echo "<div style='padding:20px;background-color:#dce8f7;color:black'> $msg</div class='btn btn-success'>" ."</br></br>";  ?>
                      ...
                      <div class="invoice-number"><img src="../../users/uploads/<?php echo $row['pics'] ;?>" width="150px" height="150px"/></div>
                    </div>
